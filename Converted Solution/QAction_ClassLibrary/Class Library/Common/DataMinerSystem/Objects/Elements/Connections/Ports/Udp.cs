	...
	public sealed class Udp : ConnectionSettings, IUdp
	{
		...
		public override int GetHashCode()
		{
			unchecked
			{
				...
				hashCode = (hashCode * 397) ^ this.remotePort;
				return hashCode;
			}
		}
		...
		{
			if (!info.LocalIPPort.Equals(String.Empty)) this.localPort = Convert.ToInt32(info.LocalIPPort);
			this.remoteHost      = info.PollingIPAddress;
			this.remotePort      = Convert.ToInt32(info.PollingIPPort);
