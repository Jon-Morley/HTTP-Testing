namespace Skyline.DataMiner.Library.Common
{
	...
	public class SnmpV3Connection : ConnectionSettings, ISnmpV3Connection
	{
		...
		internal SnmpV3Connection(ElementPortInfo info)
		{
			...
			{
				var securityLevelAndProtocol =
					HelperClass.GetEnumFromDescription<SnmpV3SecurityLevelAndProtocol>(info.StopBits);
				var encryptionAlgorithm =
					HelperClass.GetEnumFromDescription<SnmpV3EncryptionAlgorithm>(info.FlowControl);
				var authenticationProtocol =
					HelperClass.GetEnumFromDescription<SnmpV3AuthenticationAlgorithm>(info.Parity);
			...
			var portInfo = new ElementPortInfo
			               {
				               ...
				               StopBits =
					               HelperClass.GetDescriptionFromEnum(this.SecurityConfig.SecurityLevelAndProtocol),
				               FlowControl =
					               HelperClass.GetDescriptionFromEnum(this.SecurityConfig.EncryptionAlgorithm),
