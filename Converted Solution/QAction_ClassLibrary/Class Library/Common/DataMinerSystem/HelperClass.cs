...
namespace Skyline.DataMiner.Library.Common
{
	...
	internal static class HelperClass
	{
		...
		internal static T GetEnumFromDescription<T>(string description)
		{
			...
			throw new ArgumentException(description + "Not found as Enum.");

		}

		/// <summary>
		/// Get the content of description attribute of a provided Enum value.
		/// </summary>
		/// <param name="value">Enum to get the description from.</param>
		/// <returns>string value representing the description attribute value.</returns>
		internal static string GetDescriptionFromEnum(Enum value)
		{
